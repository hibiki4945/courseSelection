...
public class EmployeeChangeReq {
    ...
    public EmployeeChangeReq() {
        super();
        // TODO Auto-generated constructor stub
    }

    public EmployeeChangeReq(String employeeId, String name, int authorizationRank, String email, LocalDate birthday) {
        super();
        this.employeeId = employeeId;
        this.name = name;
        this.authorizationRank = authorizationRank;
